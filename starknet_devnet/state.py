...
class State():
    ...
    def _set_starknet_wrapper(self, starknet_wrapper: StarknetWrapper):
    ...
    def reset(self):
        ...
        self._set_starknet_wrapper(StarknetWrapper())

    def load(self, load_path: str):
        """Loads starknet wrapper from path"""
        self._set_starknet_wrapper(StarknetWrapper.load(load_path))
